...
export declare const DataSourceParsingModality: {
...
export declare const DataSourceParsingStrategy: {
    ...
    readonly BedrockDataAutomation: "BEDROCK_DATA_AUTOMATION";
};
/**
...
export declare const DataSourceType: {
    ...
    readonly RedshiftMetadata: "REDSHIFT_METADATA";
};
/**
...
export declare const KnowledgeBaseBedrockEmbeddingModelConfigurationEmbeddingDataType: {
...
export declare const KnowledgeBaseInclusionType: {
...
export declare const KnowledgeBaseQueryEngineType: {
...
export declare const KnowledgeBaseRedshiftProvisionedAuthType: {
    readonly Iam: "IAM";
...
export declare const KnowledgeBaseRedshiftQueryEngineStorageType: {
    readonly Redshift: "REDSHIFT";
    readonly AwsDataCatalog: "AWS_DATA_CATALOG";
};
/**
...
export declare const KnowledgeBaseRedshiftQueryEngineType: {
...
export declare const KnowledgeBaseRedshiftServerlessAuthType: {
    readonly Iam: "IAM";
    readonly UsernamePassword: "USERNAME_PASSWORD";
};
/**
...
export declare const KnowledgeBaseSupplementalDataStorageLocationType: {
    readonly S3: "S3";
};
/**
...
export declare const PromptVersionConversationRole: {
    readonly User: "user";
    readonly Assistant: "assistant";
};
/**
