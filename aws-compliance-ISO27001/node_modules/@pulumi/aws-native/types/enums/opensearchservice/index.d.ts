export declare const ApplicationAppConfigType: {
    readonly OpensearchDashboardsDashboardAdminUsers: "opensearchDashboards.dashboardAdmin.users";
    readonly OpensearchDashboardsDashboardAdminGroups: "opensearchDashboards.dashboardAdmin.groups";
};
/**
...
export declare const DomainRolesKeyIdcType: {
...
export declare const DomainSubjectKeyIdcType: {
