...
(function (Distribution) {
     ...
     */
    Distribution.configureAccessLogging = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(cloudfront_1.Distribution, (distribution, args, reportViolation) => {
     ...
     */
    Distribution.configureSecureTls = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     */
    Distribution.configureSecureTlsToOrigin = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(cloudfront_1.Distribution, (distribution, args, reportViolation) => {
                ...
                distribution.origins.forEach((origin) => {
                    var _a, _b;
                    (_b = (_a = origin.customOriginConfig) === null || _a === void 0 ? void 0 : _a.originSslProtocols) === null || _b === void 0 ? void 0 : _b.forEach((sslProtocol) => {
     ...
     */
    Distribution.configureWaf = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     */
    Distribution.disallowUnencryptedTraffic = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(cloudfront_1.Distribution, (distribution, args, reportViolation) => {
                ...
                if ((_a = distribution.orderedCacheBehaviors) === null || _a === void 0 ? void 0 : _a.some((orderedCacheBehavior) => orderedCacheBehavior.viewerProtocolPolicy.toLowerCase() === "allow-all")) {
                    reportViolation("CloudFront distributions should not allow unencrypted traffic.");
                }
            }),
        },
     ...
     * @link https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/AccessLogs.html
     */
    Distribution.enableAccessLogging = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     * @link https://docs.aws.amazon.com/AmazonCloudFront/latest/DeveloperGuide/using-https-cloudfront-to-s3-origin.html
     */
    Distribution.enableTlsToOrigin = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
