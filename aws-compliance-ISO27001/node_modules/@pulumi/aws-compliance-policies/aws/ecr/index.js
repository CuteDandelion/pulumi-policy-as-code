...
const ecr_1 = require("@pulumi/aws/ecr");
...
(function (Repository) {
     ...
     */
    Repository.configureCustomerManagedKey = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(ecr_1.Repository, (repo, args, reportViolation) => {
     ...
     */
    Repository.configureImageScan = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     */
    Repository.disallowMutableImage = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     * @link https://docs.aws.amazon.com/AmazonECR/latest/userguide/encryption-at-rest.html
     */
    Repository.disallowUnencryptedRepository = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     * @link https://docs.aws.amazon.com/AmazonECR/latest/userguide/image-scanning.html
     */
    Repository.enableImageScan = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
