...
(function (Secret) {
     ...
     */
    Secret.configureCustomerManagedKey = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(secretsmanager_1.Secret, (secret, args, reportViolation) => {
     ...
     * @link https://docs.aws.amazon.com/secretsmanager/latest/userguide/create_secret.html
     */
    Secret.missingDescription = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
