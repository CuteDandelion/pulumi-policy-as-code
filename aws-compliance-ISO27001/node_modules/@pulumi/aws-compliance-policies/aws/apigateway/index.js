...
const apigateway_1 = require("@pulumi/aws/apigateway");
...
(function (DomainName) {
     ...
     */
    DomainName.configureSecurityPolicy = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(apigateway_1.DomainName, (domainName, args, reportViolation) => {
