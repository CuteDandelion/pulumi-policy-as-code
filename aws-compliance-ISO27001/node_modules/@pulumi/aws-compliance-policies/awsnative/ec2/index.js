...
const ec2_1 = require("@pulumi/aws-native/ec2");
...
(function (Volume) {
     ...
     */
    Volume.configureCustomerManagedKey = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(ec2_1.Volume, (v, args, reportViolation) => {
     ...
     * @link https://docs.aws.amazon.com/AWSEC2/latest/UserGuide/EBSEncryption.html
     */
    Volume.disallowUnencryptedVolume = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
