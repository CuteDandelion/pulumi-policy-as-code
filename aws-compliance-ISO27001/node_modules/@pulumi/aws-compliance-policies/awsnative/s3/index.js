...
const s3_1 = require("@pulumi/aws-native/s3");
...
(function (Bucket) {
     ...
     */
    Bucket.configureReplicationConfiguration = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(s3_1.Bucket, (bucket, args, reportViolation) => {
     ...
     */
    Bucket.configureServerSideEncryptionCustomerManagedKey = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     */
    Bucket.configureServerSideEncryptionKms = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     */
    Bucket.disallowPublicRead = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     * @link https://docs.aws.amazon.com/AmazonS3/latest/userguide/replication.html
     */
    Bucket.enableReplicationConfiguration = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     */
    Bucket.enableServerSideEncryption = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     */
    Bucket.enableServerSideEncryptionBucketKey = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
