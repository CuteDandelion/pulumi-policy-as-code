...
const eks_1 = require("@pulumi/aws-native/eks");
...
(function (Cluster) {
     ...
     */
    Cluster.disallowApiEndpointPublicAccess = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(eks_1.Cluster, (cluster, args, reportViolation) => {
     ...
     */
    Cluster.enableClusterEncryptionConfig = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
