...
const efs_1 = require("@pulumi/aws-native/efs");
...
(function (FileSystem) {
     ...
     */
    FileSystem.configureCustomerManagedKey = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
            ...
            validateResource: (0, policy_1.validateResourceOfType)(efs_1.FileSystem, (fileSystem, args, reportViolation) => {
     ...
     */
    FileSystem.disallowBypassPolicyLockoutSafetyCheck = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     */
    FileSystem.disallowSingleAvailabilityZone = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
     ...
     */
    FileSystem.disallowUnencryptedFileSystem = compliance_policy_manager_1.policyManager.registerPolicy({
        resourceValidationPolicy: {
